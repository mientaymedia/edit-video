...
export const BUILTIN_STYLE_SEEDS: Omit<StyleDesign, "createdAt" | "updatedAt">[] = [
  ...
  {
    id: "pastel-cozy",
    name: "Pastel Dịu êm (Matcha & Sakura)",
    tags: ["cozy", "lifestyle", "podcast", "pastel"],
    colors: {
      primary: "#f472b6",
      secondary: "#a7f3d0",
      background: "#18181b",
    ...
    effects: { gradient: true, liquidGlass: true },
    logoPath: null,
    tone: "Ấm áp, chữa lành, dịu dàng, lắng đọng cảm xúc.",
    guidelines: "Phối màu hồng anh đào và xanh matcha dịu êm trên nền đen than, mang lại cảm giác bình yên, thư thái.",
  },
  {
    id: "monochrome-sleek",
    name: "Đơn sắc Tối thượng (Monochrome Studio)",
    tags: ["minimal", "fashion", "luxury", "black-white"],
    colors: {
      primary: "#e2e8f0",
      secondary: "#94a3b8",
      background: "#000000",
    ...
    fontFiles: { heading: null, body: null },
    effects: { gradient: false, liquidGlass: true },
    logoPath: null,
    tone: "Tối giản tuyệt đối, thời thượng, sắc lạnh, tinh tế.",
    guidelines: "Đơn sắc đen trắng tương phản mạnh mẽ, không dùng màu mè, tập trung 100% vào hình khối và chiều sâu ánh sáng.",
  },
  {
    id: "vintage-editorial",
    name: "Tạp chí Cổ điển (Vintage Editorial)",
    tags: ["vintage", "classic", "art", "history"],
    colors: {
      primary: "#d97706",
      secondary: "#92400e",
      background: "#1c1917",
    ...
    effects: { gradient: true, liquidGlass: true },
    logoPath: null,
    tone: "Hoài niệm, uyên bác, giàu tính lịch sử và thẩm mỹ cổ điển.",
    guidelines: "Sắc vàng hổ phách và nâu da thuộc ấm áp trên nền giấy cổ, chữ có chân serif chuẩn phong cách tạp chí thế kỷ 20.",
  },
];
